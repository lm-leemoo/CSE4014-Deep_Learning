...
def svm_loss_vectorized(
    ...
    # Replace "pass" statement with your code
    margins[margins > 0] = 1
    margins[torch.arange(num_train), y] = -margins.sum(dim=1)
    dW = X.T.mm(margins) / num_train
    dW += 2 * reg * W
    #############################################################################
    #                             END OF YOUR CODE                              #
    #############################################################################
...
def svm_get_search_params():
    ...
    regularization_strengths = [1e-2, 1e-1, 1e0, 2e0]
    ###########################################################################
    #                           END OF YOUR CODE                              #
    ###########################################################################
...
def softmax_loss_vectorized(
    ...
    correct_class_probs = probs[torch.arange(num_train), y]  # Shape: (N,)
